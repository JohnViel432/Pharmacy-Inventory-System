        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Users Management</h3> </div>
                                    ...
                                    <form class="form-horizontal" method="POST"  id="createOrderForm" action="php_action/order.php" action="php_action/order.php">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Users No</label>
                                               <div class="col-sm-4">
                                                <?php 
   ...
   $stall_no= $n."".$l; ?>
                                     ...
                                     <div class="form-group">
                                            <div class="row">
                                                ...
                                                <label class="col-sm-2 control-label">Client No.</label>
                                                <div class="col-sm-4">
                                                <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Client No." autocomplete="off" required/>
                                               </div>
...
<td >
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentType" id="paymentType">
                ...
                <option value="5">Maya Pay</option>
                <option value="6">GCash</option>
                <option value="1">Palawan Pay</option>
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                <option value="">~~SELECT~~</option>
                <option value="1">Surigao City</option>
                <option value="2">Brgy Washington</option>
                <option value="3">Brgy Lipata</option>
                <option value="4">Brgy Bonifacio</option>
                <option value="5">Brgy Poctoy</option>
                <option value="6">Brgy San Juan</option>
                <option value="7">Brgy Ipil</option>
              </select>
            </div>
                                               </div>
                                            </div>
