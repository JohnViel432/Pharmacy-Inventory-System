    ...
    <div class="container-fluid ">
        ...
        <div class="row">
            <div class="col-md-6 dashboard">
                <div class="card" style="background: darkgreen; ">
                ...
                <div class="card " style="    background-color: darkgreen ">
                    <div class="media widget-ten">
                        ...
                        <div class="media-body media-text-right">
                            ...
                            <a href="Order.php">
                                <p class="m-b-0">Users Management</p>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card" style="    background-color: darkgreen ">
                    <div class="media widget-ten">
                        ...
                        <div class="media-body media-text-right">
                            ...
                            <a href="Order.php">
                                <p class="m-b-0">Expired Medicine</p>
                            </a>
                        </div>
                    </div>
                </div>
