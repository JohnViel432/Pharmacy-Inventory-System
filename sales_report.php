...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Sales Report Management</h3>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-states">
                            <form class="form-horizontal" action="php_action/getsalereport.php" method="post"
                                ...
                                <button type="submit" id="generateReportBtn"
                                    class="btn btn-primary btn-flat m-b-30 m-t-30">Generate Report</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                if (startDate == "" || endDate == "") {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            var mywindow = window.open('', 'Rupee Invoice System',
