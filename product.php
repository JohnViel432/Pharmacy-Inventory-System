...
foreach ($result as $row) {
    ...
    ?>
                            <tr>
                                ...
                                <td><img src="assets/myimages/<?php echo $row['product_image'];?>"
                                ...
                                <td>
                                    ...
                                    <a href="editproduct.php?id=<?php echo $row['product_id']?>"><button type="button"
                                            class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>



                                    <a href="php_action/removeProduct.php?id=<?php echo $row['product_id']?>"><button
