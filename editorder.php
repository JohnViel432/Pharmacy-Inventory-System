...
//echo $sql;exit;
        ...
        <div class="form-group col-md-12">
           <label class="control-label">Client No.</label>
            <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="ClientNo." autocomplete="off" value="<?php echo $data[3] ?>" pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$"/>
      </div>       
