...
<div id="main-wrapper">
    <div class="unix-login">
        ...
        <div class="container-fluid" style="background-image: url('assets/uploadImage/Logo/pharmacy.jpg');
 background-color: #ffffff;background-size:cover">
            <div class="row ">
                <div class="col-md-4">
                    <div class="login-content ">
                        <div class="login-form">
                            <center><img src="./assets/uploadImage/Logo/favicon.png" style="width: 300px;"></center><br>
                            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="password" pattern="[a-z]{1,15}" id="password" name="password"
                                ...
                                <div class="col-md-12">
                                    <button style="background-color: #102b49; border-radius: 50px;" type="submit"
                                        name="login" class=" f-w-600 text-white btn  btn-flat m-b-30 m-t-30">Sign
                                        in</button>
